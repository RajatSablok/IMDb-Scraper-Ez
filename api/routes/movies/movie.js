...
router.get("/title/:movieId", async (req, res, next) => {
  var options = {
    uri: "https://www.imdb.com/title/" + req.params.movieId,
  ...
  rp(options)
    .then(($) => {
      ...
      let directors = summaryArr[1].trim();
      let writers = summaryArr[3].trim();
